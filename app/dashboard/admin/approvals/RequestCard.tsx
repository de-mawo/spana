...
const RequestCard = ({ requested, onClick }: Props) => {
  return (
    <div className="flex flex-col rounded-lg  shadow-md hover:scale-105 hover:shadow-lg transition-all duration-200 ease-out  border dark:text-gray-300 dark:border-gray-600">
      <div className="flex-1 flex  flex-col p-5 ">
        ...
        <div className="">
          <button
            className="flex items-center p-2 rounded-lg bg-deep-sapphire-600 hover:bg-deep-sapphire-700 text-white"
            onClick={onClick}
          >
